...
- React ZK Login Kit - Ready-to-use Component with Hook (sign-in + sign-transaction)
  - [Demo](https://demo.react-sui-zk-login.com/) - [Youtube Video Guide](https://www.youtube.com/watch?v=2qnjmKg3ugY) - [GitHub](https://github.com/denyskozak/react-sui-zk-login-kit) - [NPM](https://www.npmjs.com/package/react-sui-zk-login-kit)
...
- @SuiwareFaucetBot - Sui Faucet Bot for Telegram.
  - [GitHub](https://github.com/suiware/SuiwareFaucetBot) - ⚠️ [Telegram Bot](https://t.me/SuiwareFaucetBot)
- Suiware Faucet Chrome Extension - An experimental Chrome extension.
  - ⚠️ [GitHub](https://github.com/suiware/suiware-faucet-extension)
