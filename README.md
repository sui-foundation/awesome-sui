...
- Sui Wallet Standard (Mysten Labs) - A suite of standard utilities for implementing wallets and libraries based on the [Wallet Standard](https://github.com/wallet-standard/wallet-standard/).
  - [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/wallet-standard) - [Documentation](https://docs.sui.io/standards/wallet-standard)
...
- Sentio - Transform raw indexed data (transactions, events, etc.) into meaningful queryable data by writing custom processor logic.
  - [Homepage](https://www.sentio.xyz/indexer/) - [Documentation](https://docs.sentio.xyz/docs/sui) - [Examples](https://github.com/sentioxyz/sentio-processors/tree/main/projects) - [Further Information](details/indexer_sentio.md)
...
- DexPaprika - DEX data API covering Sui and 35 other blockchains. Pools, tokens, OHLCV, trades, and SSE streaming. Free tier, no API key required to start.
  - [Homepage](https://dexpaprika.com/) - [API Documentation](https://docs.dexpaprika.com/) - [Pricing](https://dexpaprika.com/api/pricing) - [GitHub](https://github.com/coinpaprika/dexpaprika-mcp)
